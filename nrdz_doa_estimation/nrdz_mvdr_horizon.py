# This script uses MVDR to estimate the direction of arrival (DOA)
...
# Estimate coordinates with maximum result from MVDR output
...
ang_spread_az = 90 # 0.09 # The angle spread between sources in azimuth
