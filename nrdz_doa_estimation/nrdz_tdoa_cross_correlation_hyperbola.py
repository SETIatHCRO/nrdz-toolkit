...
def main():
    ...
    print("mean est_x_src = " + str(np.mean(est_x_src)))
    print("mean est_y_src = " + str(np.mean(est_y_src)))
    print("mean est_z_src = " + str(np.mean(est_z_src)))
    ...
    max_count_idx_z = np.argmax(counts_z)
    est_z_range_tdoa_tmp = unique_z[counts_z==counts_z[max_count_idx_z]]
    est_z_range_tdoa = np.mean(est_z_range_tdoa_tmp)
    ...
    print("Estimated z range from mode = " + str(est_z_range_tdoa_tmp))
    print("Estimated z range after mean of mode = " + str(est_z_range_tdoa))
